...
{
    /// <inheritdoc />
    public partial class UpdateIncidentReportedByNullable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZendeskConfig = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZuperConfig = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRCodeSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetQRCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssetQRCodes_Assets_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZendeskTicketId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ZuperWorkOrderId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ResolutionNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClosedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EstimatedResolutionHours = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalLinks_Incidents_IncidentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetQRCodes_AssetId_IsActive",
                table: "AssetQRCodes",
                columns: new[] { "AssetId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_AssetQRCodes_QRCode",
                table: "AssetQRCodes",
                column: "QRCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalLinks_ExternalId",
                table: "ExternalLinks",
                column: "ExternalId");

            migrationBuilder.CreateIndex(
                name: "IX_ExternalLinks_IncidentId_ExternalSystem",
                table: "ExternalLinks",
                columns: new[] { "IncidentId", "ExternalSystem" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_AssetId_Status",
                table: "Incidents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_ZendeskTicketId",
                table: "Incidents",
                column: "ZendeskTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_Incidents_ZuperWorkOrderId",
                table: "Incidents",
                column: "ZuperWorkOrderId");
